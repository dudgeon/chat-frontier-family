...
`VITE_SUPABASE_URL` and `VITE_SUPABASE_ANON_KEY` point the client to your Supabase project. Real values belong in `.env.local`, which is git‑ignored. `VITE_OPENAI_MODEL` sets the model used by the edge functions when contacting OpenAI.
